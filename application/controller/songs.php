...
class Songs extends Controller
{
    ...
    public function index()
    {
        ...
        $this->smarty->assign('total_of_songs', $this->model->getAmountOfSongs());
        $this->smarty->assign('songs', $this->model->getAllSongs());
        $this->displayTemplate(__FUNCTION__);
    }
    ...
    public function editSong($song_id)
    {
        ...
        if (isset($song_id)) {
            ...
            $this->smarty->assign('song', $this->model->getSong($song_id));
